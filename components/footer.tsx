 ...
 *
 * • Named export  : Footer
 * • Default export: Footer  (for legacy imports)
 */
    ...
    <footer className="bg-gray-900 text-gray-50 py-8 px-4 md:px-6">
      <div className="container flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          <Image src="/logo.png" alt="Härnösands HF" width={30} height={30} />
        ...
        <p className="text-sm text-gray-400">
          &copy; {new Date().getFullYear()} Härnösands HF. Alla rättigheter reserverade.
        </p>
      </div>
    </footer>
  )
...
// Allow `import Footer from "@/components/footer"`
