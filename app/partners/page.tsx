...
import EditablePartnersPage from "./editable-page"

export default async function PartnersPageWrapper() {
  const content = await loadContent()
  return <EditablePartnersPage content={content.partnersPage} isEditing={false} />
}
