...
import { loadContent, type PageContent } from "@/lib/content-store" // Import loadContent
    ...
    <section className="relative w-full h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-white text-center px-4 max-w-4xl mx-auto">
        <h1 className="text-6xl md:text-8xl font-extrabold mb-4 leading-tight tracking-tight animate-fade-in-up">
          ...
          <span className="text-green-500">{content.hero.title.split(" ").slice(1).join(" ")}</span>
        </h1>
...
function StatsSection({ content }: { content: PageContent }) {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="text-4xl font-bold">{content.stats.historyYears}</div>
...
function AboutClubSection({ content }: { content: PageContent }) {
  return (
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -top-4 -right-4 bg-orange-500 text-white rounded-lg p-4 shadow-lg">
              <div className="text-3xl font-bold">{content.aboutClub.totalTeamsCallout}</div>
              <div className="text-sm">{content.aboutClub.totalTeamsCalloutText}</div>
            </div>
          </div>
        </div>
      </div>
...
function PartnersCarouselSection({ content }: { content: PageContent }) {
    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-2">
          {content.partnersCarousel.title.split(" ")[0]}{" "}
          <span className="text-orange-500">{content.partnersCarousel.title.split(" ").slice(1).join(" ")}</span>
        </h2>
        <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">{content.partnersCarousel.description}</p>
        ...
        <section className="bg-green-700 text-white p-8 rounded-lg shadow-lg text-center mt-12">
          <h2 className="text-3xl font-bold mb-4">{content.partnersCarousel.callToActionTitle}</h2>
          <p className="text-lg mb-8">{content.partnersCarousel.callToActionDescription}</p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              href={content.partnersCarousel.callToActionLink}
              className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 rounded-md"
            >
              {content.partnersCarousel.callToActionLinkText}
            </Link>
          </div>
        </section>
      </div>
...
export default function Home() {
  ...
  return (
    <>
      ...
      <AboutClubSection content={content} />
